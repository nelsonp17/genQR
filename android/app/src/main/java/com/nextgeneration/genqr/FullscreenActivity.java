...
import com.nextgeneration.genqr.databinding.ActivityFullscreenBinding;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**FullscreenActivity.instance = this;
        // TODO make sure to remove this line in production
        StartAppSDK.initParams(this, "206837052")
    ...
    public void intersticialAuto(){
        startAppAd.loadAd(StartAppAd.AdMode.AUTOMATIC);
    }
    public void intersticialVideo(){
        startAppAd.loadAd(StartAppAd.AdMode.VIDEO);
    }

    public void start(){
        //StartAppSDK.init(this, "206837052", true);
