...
const SmsComponent: React.FC = ({ onTextChange }: any) => {
	...
	const elems: FormElement[] = [
		...
		{
			type: 'textarea', placeholder: 'Mensaje', name: 'mensage', value: inputValue.mensage, className: 'input-theme', handleChange,
		},
	]
